...
Page({
  ...
  onSelect: function(e) {
    ...
    // if (that.data.currentTab == 0) {
      ...
      community.getDynamicList(that.data.page, that.data.userId, 0, that.data.sort,(res) => {
  ...
  toDetail1:function(e){
    ...
    var id = e.currentTarget.dataset.dyid;
    community.dynamicInfo(id, res => {
  ...
  onReachBottom: function() {
    ...
    community.getDynamicList(that.data.page, that.data.userId, that.data.event_type, that.data.sort, (res) => {
  ...
  onbaoxian:function(e){

    var servicetype = e.currentTarget.dataset.servicestyle
    wx.navigateTo({
      url: './baoxian/baoxian?servicetype=' + servicetype,
    })
  }
